...
open class PasscodeLockPresenter {
    ...
    fileprivate lazy var passcodeLockWindow: UIWindow = {
        ...
        window.windowLevel = UIWindow.Level.init(0)
    ...
    public init(mainWindow window: UIWindow?, configuration: PasscodeLockConfigurationType, viewController: PasscodeLockViewController) {
        ...
        mainWindow = window
        mainWindow?.windowLevel = UIWindow.Level.init(1)
    ...
    open func presentPasscodeLock() {
        ...
        passcodeLockWindow.windowLevel = UIWindow.Level.init(2)
    ...
    open func dismissPasscodeLock(animated: Bool = true) {
        ...
        if animated {
            ...
            passcodeLockWindow.windowLevel = UIWindow.Level.init(0)
    ...
    internal func animatePasscodeLockDismissal() {
        ...
        UIView.animate(
            ...
            completion: { [weak self] _ in
                ...
                self?.passcodeLockWindow.windowLevel = UIWindow.Level.init(0)
